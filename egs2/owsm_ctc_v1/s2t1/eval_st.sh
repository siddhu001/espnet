...
tgt_case=tc
tgt_lang=de
test_sets="MuST-C_v2_en-de/tst-COMMON.en-de"
data_feats=dump/raw
...
st_exp=exp/s2t_train_s2t_finetune_multitask_ebf_e24_lr2e-4_raw_bpe5000
inference_tag=decode_s2t_task_symst_de_s2t_model_valid.total_count.ave_10best
