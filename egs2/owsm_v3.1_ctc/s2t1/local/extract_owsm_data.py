...
if __name__ == "__main__":
    ...
    tokenizer = build_tokenizer(
        token_type="bpe",
        bpemodel="/scratch/bbjs/peng6/espnet-whisper-public/egs2/owsm_v3.1/s2t1/data/token_list/bpe_unigram50000/bpe.model",
    )

    token_id_converter = TokenIDConverter(
        token_list="/scratch/bbjs/peng6/espnet-whisper-public/egs2/owsm_v3.1/s2t1/data/token_list/bpe_unigram50000/tokens.txt",
        unk_symbol="<unk>",
    )

    for name in ['train_v3',]:
