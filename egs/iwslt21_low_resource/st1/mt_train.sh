...
feat_tr_dir=dump/mt/
feat_dt_dir=${dumpdir}/${train_dev}/deltafalse; mkdir -p ${feat_dt_dir}
mkdir -p ${feat_tr_dir}
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    ${cuda_cmd} --gpu ${ngpu} ${expdir}/train.log \
        ...
        --verbose ${verbose} \
        --resume ${resume} \
        --train-json ${feat_tr_dir}/data_bpe${nbpe}.${src_case}_${tgt_lang}.json \
	--valid-json ${feat_tr_dir}/data_dt_bpe${nbpe}.${src_case}_${tgt_lang}.json
fi
